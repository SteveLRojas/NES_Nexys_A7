...
#
# Generated by Vivado on Mon Jul 10 21:34:32 CEST 2023
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Nexys_A7_NES.gen/sources_1/ip/pll/pll_clk_wiz.v" \
    "$ref_dir/../../../../Nexys_A7_NES.gen/sources_1/ip/pll/pll.v" \
  2>&1 | tee -a vlogan.log
